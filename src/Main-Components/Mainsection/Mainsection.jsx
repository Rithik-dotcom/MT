...
const Mainsection = () => {
  return (
    <div className='main-background' style={{backgroundColor: "rgba(11, 19, 36, var(--opacity,1))"}}>
        <div class="container mb-lg-8 main-background">
                    <div class="row">
                        {/* {/* col -->*/} 
                        <div class="col-12">
                            <div class="mb-6">
                                <h2 class="mb-1 h1 text-white">Most Popular Courses</h2>
                                <p className='text-white'>These are the most popular courses among Geeks Courses learners worldwide in year 2022</p>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                                    ...
                                    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                                        <div class="col">
                                            ...
                                            <div class="card card-hover">
                                                <a href="../course-single.html"><img src="https://geeksui.codescandy.com/geeks/assets/images/course/course-javascript.jpg" alt="course" class="card-img-top"/></a>
                                                {/* {/* Card Body -->*/}
                                                <div class="card-body">
                                        ...
                                        <div class="col">
                                            {/* {/* Card -->*/}
                                            <div class="card card-hover">
                                                <a href="../course-single.html"><img src="https://geeksui.codescandy.com/geeks/assets/images/course/course-css.jpg" alt="course" class="card-img-top"/></a>
                                                {/* {/* Card Body -->*/}
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        ...
                                        <div class="col">
                                            {/* {/* Card -->*/}
                                            <div class="card card-hover">
                                                <a href="../course-single.html"><img src="https://geeksui.codescandy.com/geeks/assets/images/course/course-gatsby.jpg" alt="course" class="card-img-top"/></a>
                                                {/* {/* Card Body -->*/}
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                                        <span class="badge bg-info-soft">Intermediate</span>
                                        ...
                                        <div class="col">
                                            {/* {/* Card -->*/}
                                            <div class="card card-hover">
                                                <a href="../course-single.html"><img src="https://geeksui.codescandy.com/geeks/assets/images/course/course-wordpress.jpg" alt="course" class="card-img-top"/></a>
                                                {/* {/* Card Body -->*/}
                                                <div class="card-body">
                                                    <div class="d-flex justify-content-between align-items-center mb-3">
