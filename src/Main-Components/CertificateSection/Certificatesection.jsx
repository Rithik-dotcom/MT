...
const Certificatesection = () => {
  return (
    <div>
        <section class="pb-lg-8 pb-6 certificate-background">
                    ...
                    <div class="row">
                        <div class="col-xl-6 offset-xl-3 col-md-12 col-12">
                            <div class="text-center mb-lg-8 mb-6">
                                <h2 class="h1 fw-bold">
                                    Building strong
                                    <u class="text-warning"><span >foundational skills</span></u>
                                </h2>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-5 col-lg-6 col-md-12 col-12">
                            <div class="mb-6 mb-lg-0">
                                <div class="mb-2">
                                    <img src="https://geeksui.codescandy.com/geeks/assets/images/education/certificate.jpg" alt="certificate" class="img-fluid w-100"/>
                                </div>
                                <div class="d-flex">
                                    <span>
